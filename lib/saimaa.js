...
(function() {
  ...
  Saimaa = (function() {
    function Saimaa(source) {
      ...
      document.addEventListener("selectionchange", (function(_this) {
        return function(event) {
          return _this.onSelectedTextChange(event);
        };
      })(this));
    }
    ...
    Saimaa.prototype.onSelectedTextChange = function(event) {
      var height;
      if (document.getSelection().toString().length > 0) {
        this.ui.selectionUI.style.display = "flex";
        height = this.ui.selectionUI.clientHeight;
        this.ui.selectionUI.style.top = (parseInt(this.dom.lastNode.offsetTop + height)) + "px";
        return this.ui.selectionUI.style.left = (parseInt(this.dom.lastNode.offsetLeft)) + "px";
      } else {
        return this.ui.selectionUI.style.display = "none";
      }
    };
